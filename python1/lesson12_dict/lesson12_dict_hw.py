# Домашнее задание по словарям dict:
...
# Посчитайте количество слов в тексе. Не забудьте привести все буквы к нижнему регистру и удалите знаки препинания.
# Выведите результат в виде словаря, где ключ - слово, а значение это количество повторений слова.
