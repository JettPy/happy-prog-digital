...
# Функции
# В python можно создавать свои собственные функции:
# def - от слова define "определить"
# def <имя функции> (<аргументы, если они есть>):   <- не теряйте двоеточие
#    <тело функции>

# Тело функции отделяется отступами слева.
...
say_hi('John')  # Вывод: Hi, John!


# Функции могут возвращать какие-то значения, как делает это input. Для этого используется команда return.
# После выполнения return происходит выход из функции:
def summa(a, b):
    c = a + b
    return c


print(summa(2, 3))  # Вывод: 5
