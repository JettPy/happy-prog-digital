...
# Дело в том что Python - это ООП язык, и в нем нет простых типов. Все есть классы.
...
# Python не поддерживает инкапсуляцию как другие ООП языки, но понимать как работают модификаторы доступа нужно.
